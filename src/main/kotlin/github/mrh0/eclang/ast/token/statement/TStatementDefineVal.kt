...
import github.mrh0.eclang.ir.IRStatementDefineVal

class TStatementDefineVal(location: Loc, private val varName: String, private val expr: ITok) : Tok(location) {
    override fun process(cd: CompileData, hint: EcType): Pair<EcType, IIR> {
        ...
        return Pair(ir.first, IRStatementDefineVal(location, index, ir.second))
    }
