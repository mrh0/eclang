...
public class EclangParser extends Parser {
	...
	public static final int
		...
		T__73=74, T__74=75, NL=76, BOOL=77, NAME=78, ATOM=79, INT=80, UINT=81, 
		FLOAT=82, DOUBLE=83, HEX=84, BIN=85, CHAR=86, STRING=87, EMBEDED=88, WHITESPACE=89, 
		EMPTYLINE=90, COMMENT=91, BLOCKCOMMENT=92, INDENT=93, DEDENT=94;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'unsafe'", "'.'", "'?.'", "'['", "']'", "','", "'{'", "'='", "'}'", 
			"'@'", "'?'", "'inter'", "':'", "'var'", "'val'", "'break'", "'continue'", 
			"'pass'", "'yeild'", "'defer'", "'do'", "'while'", "'for'", "'in'", "'where'", 
			"'ret'", "'pool'", "'from'", "'declare'", "'fn'", "'type'", "'rec'", 
			"'use'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, "NL", "BOOL", "NAME", "ATOM", "INT", "UINT", 
			"FLOAT", "DOUBLE", "HEX", "BIN", "CHAR", "STRING", "EMBEDED", "WHITESPACE", 
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 9151877923198730302L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 16638003L) != 0) );
			setState(48);
			match(DEDENT);
			}
		}
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						binOp();
						setState(262);
						((ExprBinOpContext)_localctx).right = expr(36);
						}
						break;
					case 2:
						{
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 56)) & ~0x3f) == 0 && ((1L << (_la - 56)) & 884739L) != 0)) {
				{
				setState(803);
				_errHandler.sync(this);
