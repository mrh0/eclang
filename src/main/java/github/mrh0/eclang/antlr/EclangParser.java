...
public class EclangParser extends Parser {
	...
	public static final int
		...
		T__87=88, T__88=89, NL=90, BOOL=91, NAME=92, ATOM=93, UINT=94, UCHAR=95, 
		USHORT=96, ULONG=97, SHORT=98, INT=99, CHARNUM=100, LONG=101, FLOAT=102, 
		DOUBLE=103, HEX=104, BIN=105, CHAR=106, STRING=107, EMBEDED=108, WHITESPACE=109, 
		EMPTYLINE=110, COMMENT=111, BLOCKCOMMENT=112, INDENT=113, DEDENT=114;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'...'", "'const'", "'var'", "'val'", "'break'", "'when'", "'continue'", 
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & -4609151098664517506L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 17592051899387L) != 0) );
			setState(55);
			match(DEDENT);
			}
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class StatementWhenContext extends StatementContext {
		...
		public StatementWhenContext(StatementContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof EclangListener ) ((EclangListener)listener).enterStatementWhen(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof EclangListener ) ((EclangListener)listener).exitStatementWhen(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof EclangVisitor ) return ((EclangVisitor<? extends T>)visitor).visitStatementWhen(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public final StatementContext statement() throws RecognitionException {
		...
		try {
			...
			case 14:
				...
				break;
			case 15:
				_localctx = new StatementWhenContext(_localctx);
				enterOuterAlt(_localctx, 15);
				{
				setState(519);
				((StatementWhenContext)_localctx).expression = expr(0);
				setState(520);
				match(T__65);
				setState(521);
				((StatementWhenContext)_localctx).when = expr(0);
				setState(522);
				match(NL);
				}
				break;
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 63)) & ~0x3f) == 0 && ((1L << (_la - 63)) & 89653251L) != 0)) {
				{
				setState(912);
				_errHandler.sync(this);
