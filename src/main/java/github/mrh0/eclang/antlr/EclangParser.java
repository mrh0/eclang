...
public class EclangParser extends Parser {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'do'", "'while'", "'for'", "'in'", "'to'", "'where'", "'ret'", "'declare'", 
			"'fn'", "'type'", "'rec'", "'use'"
		};
	}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & -2303308089450823554L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 17179739247L) != 0) );
			setState(55);
			match(DEDENT);
			}
		}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 61)) & ~0x3f) == 0 && ((1L << (_la - 61)) & 442371L) != 0)) {
				{
				setState(817);
				_errHandler.sync(this);
